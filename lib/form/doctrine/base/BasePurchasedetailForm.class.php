 ...
 *
 * @method Purchasedetail getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BasePurchasedetailForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'sellprice'    => new sfValidatorNumber(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('purchasedetail[%s]');
